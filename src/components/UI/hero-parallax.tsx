...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full  left-0 top-0">
      <h1 className="text-2xl md:text-7xl font-bold font-Fatface text-white">
       Check Out Some Of My<br /> Personal Projects
      </h1>
      <p className="max-w-2xl text-base md:text-xl mt-8 text-white">
       I put my sweat and tears into them, and alot of Coffee.
      </p>
    </div>
  );
};
